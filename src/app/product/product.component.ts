...
export class ProductComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    var allproducts = [
      { category: 'cat', subCat: 'cat food', productname: 'meow mix', subCatcode: 1, imgPath: "../../assets/images/meowmix.jpg", price: '100', desc: 'fuhsuf suhfushdf asf sudhfusdf usfsud jjjasdj nnkd fksdfsd ksfs kite cf skf  wat s the all the main sf sf dfsf so thsat  sdfk ssoft soft mostly by the evedkf fhsf  suhfus' },
      ...
      { category: 'cat', subCat: 'toys', productname: 'Interactive Cat Toy Electric Moving Butterfly', subCatcode: 3, imgPath: "../../assets/images/cattoys.jpg", price: '1200', desc: 'kfs a kdfsdf ksd f skfksfasdf sdkfsf sdj' },
